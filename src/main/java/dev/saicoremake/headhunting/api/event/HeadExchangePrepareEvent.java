...
public final class HeadExchangePrepareEvent extends Event implements Cancellable {
    private static final HandlerList HANDLERS = new HandlerList();
    private final Player player;
    private final ExchangeRecipe recipe;
    private final List<SaleLine> lines;
    private boolean cancelled;

    public HeadExchangePrepareEvent(Player player, ExchangeRecipe recipe, List<SaleLine> lines) {
